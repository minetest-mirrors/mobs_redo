...
* Refactor mob functions.
* Optimize mob functions.
* Deprecate register_arrow's tail=1 setting, use tail_texture to enable.
* Deprecate mob jump setting, use jump_height=0 to disable.
